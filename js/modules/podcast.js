...
var podcastCourses = [
    ...
    {id:'podcast18',title:'Week1复盘&Week2记忆训练计划',teacher:'心理学专家',duration:'6:45',durationSec:405,category:'学霸方法',gradient:'linear-gradient(135deg,#fa709a,#fee140)',icon:'🚀',shareUrl:null,url:'https://coze-coding-project.tos.coze.site/coze_storage_7630375842421407780/audio/tts_6d85df3b-f0c1-4db4-84cc-1fc5713a8770.mp3?sign=1808822567-1d7a431598-0-0cf9163a9cb1a7e1ebc60450eebd1ab2b5cffac744929bde2400c787f4c297b2',views:21800},
    {id:'podcast19',title:'青小年训练周报：数学物理思维入门',teacher:'心理辅导师',duration:'5:50',durationSec:350,category:'学霸方法',gradient:'linear-gradient(135deg,#43E97B,#38F9D7)',icon:'😌',shareUrl:'https://www.coze.cn/s/SjBR-HOwR98/',url:'https://coze-coding-project.tos.coze.site/coze_storage_7630375842421407780/audio/tts_a88e8a8c-0057-4796-8901-1544f6c23f1a.mp3?sign=1808822587-631539fd14-0-6ac1c3d986d4eb054f5f1bcd7c9f0151331b9921750fee12bfd79847c139cbf3',views:18700},
    {id:'podcast20',title:'青小年训练周报：Week3思维整合入门',teacher:'学习方法专家',duration:'4:20',durationSec:260,category:'学霸方法',gradient:'linear-gradient(135deg,#667eea,#764ba2)',icon:'📒',shareUrl:'https://www.coze.cn/s/ATJKT6u6G7E/',url:'https://coze-coding-project.tos.coze.site/coze_storage_7630375842421407780/audio/tts_7252efa2-6a55-4885-ba32-9a647e8c4dc3.mp3?sign=1808822608-b3cf17f9dc-0-1c1d14238dfba63232f0ce2ffcd9cacf10312b7a6b254d32521e40f724eafa81',views:14200},
    {id:'podcast21',title:'青小年训练周报四周完结篇',teacher:'时间管理导师',duration:'7:30',durationSec:450,category:'学霸方法',gradient:'linear-gradient(135deg,#FF9A63,#E87A4E)',icon:'📅',shareUrl:'https://www.coze.cn/s/Illp6Wnea3A/',url:'https://coze-coding-project.tos.coze.site/coze_storage_7630375842421407780/audio/tts_e114fd3c-f458-4930-b538-c269094d2df5.mp3?sign=1808822631-9eb2c6ff85-0-51ecf4698fa33b41dc2925d44fe3b9daf19ed6f84ff90dea30233bc0832719f9',views:16500}
]
...
function playPodcastCourse(courseId) {
    ...
    if (course.url) {
        ...
        audioEl.play().then(function() {
            ...
            console.warn('TOS直链播放失败，尝试shareUrl方式:', e);
            // TOS直链失败，fallback到shareUrl动态签名
            if (course.shareUrl) {
                playPodcastViaShareUrl(course, courseId, audioEl);
            } else {
                showToast('播放失败');
            }
        });
    ...
    // 显示播放器UI
    showMiniPlayer(course);
    var playerEl2 = document.getElementById('audio-player-fullscreen');
    var coverPlayingEl2 = document.getElementById('ap-cover');
    if (playerEl2) playerEl2.classList.add('show');
    if (coverPlayingEl2) coverPlayingEl2.classList.add('playing');
    updatePodcastListState(courseId);
