...
window._applyRoleModules = function() {
    ...
    var studentModules = ['assessment', 'exam', 'mindmap', 'practice', 'method', 'thinking', 'podcast', 'video', 'library', 'selfdrive', 'pet', 'wrongbook', 'pomodoro', 'ai'];
    ...
    } else if (role === 'parent' && window._loadLazyModule) {
        window._loadLazyModule('parent-dashboard', function() {
            if (window.renderParentDashboard) {
                var parentDiv = document.createElement('div');
                parentDiv.id = 'parent-dashboard-inline';
                parentDiv.style.cssText = 'grid-column:1/-1;';
                grid.appendChild(parentDiv);
    ...
    } else if (role === 'admin' && window._loadLazyModule) {
        window._loadLazyModule('admin-dashboard', function() {
