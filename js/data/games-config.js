...
window.gameConfig = {
    ...
    emotion: {name:'😊 表情识别',color:'#FF9A9E',gradient:'linear-gradient(135deg,#ff9a9e,#fad0c4)'},
    social: {name:'🤝 社交情景',color:'#A8E6CF',gradient:'linear-gradient(135deg,#43e97b,#38f9d7)'},
    routine: {name:'🌅 生活排序',color:'#FBC2EB',gradient:'linear-gradient(135deg,#fbc2eb,#a6c1ee)'},
